  ...
  return (
    <div className="w-full flex flex-col gap-4 mt-6">
      ...
      <button
        ...
        className="w-full py-5 rounded-2xl text-lg font-bold bg-white/10 text-white border-2 border-white/25 backdrop-blur-sm hover:bg-white/20 hover:-translate-y-0.5 transition-all"
      >
        <span className="mr-2.5 text-xl">🔑</span>
        Rejoindre
      </button>
