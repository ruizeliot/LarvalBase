    ...
    <MainLayout sidebar={<AppSidebar onSelectSpecies={(sp) => { setCameFromFamily(null); setCameFromGallery(false); setViewMode('species'); setSelectedSpecies(sp); }} onFilteredSpeciesChange={handleFilteredSpeciesChange} />}>
      {viewMode === 'species' && selectedSpecies ? (
        <SpeciesDetail
          ...
          backLabel={cameFromFamily ? `Back to family gallery` : cameFromGallery ? `Back to gallery` : `Back to homepage`}
        />
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-snug mt-3">
                LarvalBase was further enriched by an additional 9,357 colored pictures of post-flexion and early juveniles of 1,929 species obtained from 196 sources. Various growth rate models from 47 original references and 90 populations are also now newly displayed, along with age-at-length data. Finally, expert-based distribution areas (IUCN or literature analyses) or unfiltered occurrences (OBIS, GBIF, VertNet, iDigBio and iNaturalist), depending on availability, were acquired for 17,279 marine fish species, to allow filtering families, genera and species by Marine Ecoregions (Spalding et al., 2007) or Pelagic Provinces (Spalding et al., 2012) of the world.
              </p>
              <p className="text-xs text-muted-foreground leading-snug mt-3">
