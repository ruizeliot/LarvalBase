...
export async function GET() {
  try {
    ...
    const THUMBNAIL_OVERRIDES: Record<string, { path: string; filename: string }> = {
      ...
      'Epinephelidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Mears (2026) - 8905.jpg' },
      ...
      'Paralichthyidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Vasquez-Yeomans et al. (2011) - 717.jpg' },
      ...
      'Myctophidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Gug (2026) - 8755.jpg' },
      'Chiasmodontidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6576.jpg' },
      ...
      'Blenniidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Kovacs (2026) - 6925.jpg' },
