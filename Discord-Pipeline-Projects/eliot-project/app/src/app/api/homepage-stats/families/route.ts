...
export async function GET() {
  try {
    ...
    // Uses watermarked filenames (Copyright ... format) matching VPS image structure
    const THUMBNAIL_OVERRIDES: Record<string, { path: string; filename: string }> = {
      // --- Existing curated overrides ---
      'Gobiidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Minemizu (2026) - 8669.jpg' },
      'Ophidiidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Kovacs (2026) - 6953.jpg' },
      'Holocentridae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Mazda (2026) - 8674.jpg' },
      'Scorpaenidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6909.jpg' },
      'Paralichthyidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Jensen (2026) - 6625.jpg' },
      'Acanthuridae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Meldonian (2026) - 6323.jpg' },
      'Synodontidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Meldonian (2026) - 7298.jpg' },
      'Antennariidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6364.jpg' },
      'Peristediidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Gug (2026) - 8915.jpg' },
      'Gibberichthyidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6788.jpg' },
      'Brotulidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6482.jpg' },
      'Xiphiidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Kovacs (2026) - 7364.jpg' },
      'Diodontidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6723.jpg' },
      'Chiasmodontidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Zhang F. (2026) - 9069.jpg' },
      'Carangidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Ianiello (2026) - 8603.jpg' },
      'Pomacentridae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6712.jpg' },
      'Labridae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Ianiello (2026) - 7310.jpg' },
      'Apogonidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_family', filename: 'Copyright Ianiello (2026) - 8486.jpg' },
      'Blenniidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Baensch (2026) - 6769.jpg' },
      'Ostraciidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6948.jpg' },
      'Gigantactinidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright BW FB group (2026) - 6059.jpg' },
      // --- Round 31: Eliot-requested overrides ---
      'Sparidae': { path: 'Final image database - Watermarks - Compressed/Guadeloupe', filename: 'Copyright Ruiz et al. (2026) - 4188.JPG' },
      'Epinephelidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 7345.jpg' },
      'Gerreidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Grande et al. (2019) - 16.png' },
      'Anguillidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Tsukamoto et al. (2009) - 203.png' },
      'Sciaenidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Vasquez-Yeomans et al. (2011) - 2164.jpg' },
      'Fistulariidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_genus', filename: 'Copyright Baensch (2026) - 8356.jpg' },
      ...
      'Cottidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Sakuma et al. (2013) - 8075.png' },
      'Pempheridae': { path: 'Maldives', filename: 'Copyright Ruiz et al. (2026) - 5286.jpg' },
      'Pseudochromidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Chen et al. (2023) - 2379.png' },
      'Nettastomatidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Miller (2023) - 7494.png' },
      'Chlopsidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Moore et al. (2020) - 643.png' },
      'Engraulidae': { path: 'Final image database - Watermarks - Compressed/other_genus_pictures', filename: 'Copyright Ruiz et al. (2026) - 7727.JPG' },
      'Hapalogenyidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright the99spiker (2024) - 1387.png' },
      'Leiognathidae': { path: 'Final image database - Watermarks - Compressed/Vietnam', filename: 'Copyright Pham & Durand (2017) - 5340.jpg' },
      'Liparidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Sakuma et al. (2013) - 8123.png' },
      'Spratelloididae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Sakuma et al. (2013) - 8123.png' },
      'Elopidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Moore et al. (2020) - 13.png' },
      'Lophotidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Minemizu (2026) - 6990.jpg' },
      'Synagropidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright the99spiker (2019) - 2159.png' },
      ...
      'Chaenopsidae': { path: 'Final image database - Watermarks - Compressed/Larvae literature images database - Renamed', filename: 'Copyright Vasquez-Yeomans et al. (2011) - 75.png' },
      'Labrisomidae': { path: 'Final image database - Watermarks - Compressed/Guadeloupe', filename: 'Copyright Ruiz et al. (2026) - 5010.JPG' },
      'Serranidae': { path: 'Final image database - Watermarks - Compressed/classified_bw_images_species', filename: 'Copyright Ianiello (2026) - 7231.jpg' },
      'Nemipteridae': { path: 'Final image database - Watermarks - Compressed/Fisher - Cropped', filename: 'Copyright Fisher et al. (2022) - 5685.JPG' },
    };
