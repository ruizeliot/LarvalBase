...
export async function GET() {
  try {
    ...
    const THUMBNAIL_OVERRIDES: Record<string, { path: string; filename: string }> = {
      ...
      'Gobiidae': { path: 'classified_bw_images_family', filename: 'Minemizu (2026) - 8669.jpg' },
      'Ophidiidae': { path: 'classified_bw_images_species', filename: 'Kovacs (2026) - 6953.jpg' },
      'Holocentridae': { path: 'classified_bw_images_family', filename: 'Mazda (2026) - 8674.jpg' },
      'Scorpaenidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6909.jpg' },
      'Paralichthyidae': { path: 'classified_bw_images_species', filename: 'Jensen (2026) - 6625.jpg' },
      'Acanthuridae': { path: 'classified_bw_images_species', filename: 'Meldonian (2026) - 6323.jpg' },
      'Synodontidae': { path: 'classified_bw_images_species', filename: 'Meldonian (2026) - 7298.jpg' },
      'Antennariidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6364.jpg' },
      'Peristediidae': { path: 'classified_bw_images_family', filename: 'Gug (2026) - 8915.jpg' },
      'Gibberichthyidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6788.jpg' },
      'Brotulidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6482.jpg' },
      'Xiphiidae': { path: 'classified_bw_images_species', filename: 'Kovacs (2026) - 7364.jpg' },
      'Diodontidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6723.jpg' },
      'Chiasmodontidae': { path: 'classified_bw_images_family', filename: 'Zhang F. (2026) - 9069.jpg' },
      'Carangidae': { path: 'classified_bw_images_family', filename: 'Ianiello (2026) - 8603.jpg' },
      'Pomacentridae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6712.jpg' },
      'Labridae': { path: 'classified_bw_images_species', filename: 'Ianiello (2026) - 7310.jpg' },
      'Apogonidae': { path: 'classified_bw_images_family', filename: 'Ianiello (2026) - 8486.jpg' },
      'Blenniidae': { path: 'classified_bw_images_species', filename: 'Baensch (2026) - 6769.jpg' },
      'Ostraciidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6948.jpg' },
      'Gigantactinidae': { path: 'classified_bw_images_species', filename: 'BW FB group (2026) - 6059.jpg' },
      // --- Round 31: Eliot-requested overrides ---
      'Sparidae': { path: 'Guadeloupe', filename: 'Ruiz et al. (2026) - 4188.JPG' },
      'Epinephelidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 7345.jpg' },
      'Gerreidae': { path: 'Larvae literature images database - Renamed', filename: 'Grande et al. (2019) - 16.png' },
      'Anguillidae': { path: 'Larvae literature images database - Renamed', filename: 'Tsukamoto et al. (2009) - 203.png' },
      'Sciaenidae': { path: 'Larvae literature images database - Renamed', filename: 'Vasquez-Yeomans et al. (2011) - 2164.jpg' },
      'Fistulariidae': { path: 'classified_bw_images_genus', filename: 'Baensch (2026) - 8356.jpg' },
      'Myctophidae': { path: 'classified_bw_images_family', filename: 'BW FB group (2026) - 8758.jpg' },
      'Kyphosidae': { path: 'classified_bw_images_family', filename: 'Baensch (2026) - 8644.jpg' },
      'Cottidae': { path: 'Larvae literature images database - Renamed', filename: 'Sakuma et al. (2013) - 8075.png' },
      'Pempheridae': { path: 'Maldives', filename: 'Ruiz et al. (2026) - 5286.jpg' },
      'Pseudochromidae': { path: 'Larvae literature images database - Renamed', filename: 'Chen et al. (2023) - 2379.png' },
      'Nettastomatidae': { path: 'Larvae literature images database - Renamed', filename: 'Miller (2023) - 7494.png' },
      'Chlopsidae': { path: 'Larvae literature images database - Renamed', filename: 'Moore et al. (2020) - 643.png' },
      'Engraulidae': { path: 'other_genus_pictures', filename: 'Ruiz et al. (2026) - 7727.JPG' },
      'Hapalogenyidae': { path: 'Larvae literature images database - Renamed', filename: 'the99spiker (2024) - 1387.png' },
      'Leiognathidae': { path: 'Vietnam', filename: 'Pham & Durand (2017) - 5340.jpg' },
      'Liparidae': { path: 'Larvae literature images database - Renamed', filename: 'Sakuma et al. (2013) - 8123.png' },
      'Spratelloididae': { path: 'Larvae literature images database - Renamed', filename: 'Sakuma et al. (2013) - 8123.png' },
      'Elopidae': { path: 'Larvae literature images database - Renamed', filename: 'Moore et al. (2020) - 13.png' },
      'Lophotidae': { path: 'classified_bw_images_species', filename: 'Minemizu (2026) - 6990.jpg' },
      'Synagropidae': { path: 'Larvae literature images database - Renamed', filename: 'the99spiker (2019) - 2159.png' },
      'Caristiidae': { path: 'classified_bw_images_family', filename: 'Zhang J. (2026) - 9060.jpg' },
      'Eurypharyngidae': { path: '.', filename: 'Poulsen et al. (2018) - 7474.png' },
      // --- Round 32: More thumbnail overrides ---
      'Chaenopsidae': { path: 'Larvae literature images database - Renamed', filename: 'Vasquez-Yeomans et al. (2011) - 75.png' },
      'Labrisomidae': { path: 'Guadeloupe', filename: 'Ruiz et al. (2026) - 5010.JPG' },
      'Serranidae': { path: 'classified_bw_images_species', filename: 'Ianiello (2026) - 7231.jpg' },
      'Nemipteridae': { path: 'Fisher - Cropped', filename: 'Fisher et al. (2022) - 5685.JPG' },
    };
