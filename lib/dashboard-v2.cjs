...
function render() {
  ...
  lines.push(line('  ' + C.yellow + '[↑↓]' + C.reset + ' Nav   ' + C.yellow + '[Tab]' + C.reset + ' Expand   ' + C.yellow + '[Space]' + C.reset + ' ' + modeColor + modeLabel + C.reset + '   ' + C.dim + '│' + C.reset + '   ' + C.yellow + '[r]' + C.reset + ' Analyze', W));
