# Phase 1: Brainstorm Facilitator (Archived from CLAUDE.md)

**Archived:** 2026-02-11
**Reason:** Moved out of CLAUDE.md to reduce context window consumption. These instructions are available via skills (`interactive-brainstorm`, `anthohunt-1a-brainstorm`).
